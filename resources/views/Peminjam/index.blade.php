...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a href="{{ route('home') }}" 
               class="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors group">
                <div class="w-12 h-12 bg-slate-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                    <span class="material-icons text-white">home</span>
                </div>
                <div>
                    <h4 class="font-semibold text-slate-900 dark:text-white">Kembali ke Beranda</h4>
                    <p class="text-sm text-slate-500 dark:text-slate-400">Lihat landing page</p>
                </div>
            </a>
        </div>
    </div>
