    ...
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-primary to-indigo-600 rounded-xl p-8 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-blue-100">Kelola KantorKuu dengan kontrol penuh</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ route('admin.reports') }}"
                ...
                <div
                    class="w-10 h-10 bg-amber-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            @if(isset($pendingBorrowings) && count($pendingBorrowings) > 0)
                <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
                    <div class="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                        ...
                        <span
                            class="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded-full text-xs font-semibold">
                            ...
                            <div class="p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="font-semibold text-sm text-slate-900 dark:text-white">
                                        {{ $borrowing->user->name ?? 'User' }}</h4>
                                    <span
                                        class="text-xs text-slate-500 dark:text-slate-400">{{ $borrowing->created_at ? $borrowing->created_at->diffForHumans() : '-' }}</span>
                                </div>
